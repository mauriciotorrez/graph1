...
import dashboard from '../../assets/img/team/3.jpg';
import dashboardDark from '../../assets/img/team/3.jpg';
...
const Banner = () => {
  ...
  return (
    <Section className="py-0 overflow-hidden" image={null} position="center bottom" overlay>
